...
<div <?php echo esc_attr(get_block_wrapper_attributes()); ?>>
	...
	<?php endif; ?>
	<input type="number" id="amount-box" class="frz-input" min="<?php echo esc_attr($minimum); ?>" placeholder="<?php echo esc_attr(Utils::currency_format($minimum, ['no_symbol'])); ?>" data-product-id="<?php echo esc_attr($product_id); ?>">
	<?php if ($minimum_meta) : ?>
